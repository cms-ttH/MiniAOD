...
void LeptonSFHelper::SetElectronHistos( ){
  ...
  std::string IDinputFile = "data/leptonSF/ScaleFactor_GsfElectronToRECO_passingTrigWP80.txt.egamma_SF2D.root";
  std::string TRIGGERinputFile = "data/leptonSF/eleTrig_SF.root";
  //std::string ISOinputFile = std::string(getenv("CMSSW_BASE")) + "/src/MiniAOD/MiniAODHelper/data/leptonSF/" + "Isolation_SF.root";
  std::string ISOinputFile = "data/leptonSF/eleRECO.txt.egamma_SF2D.root";
...
void LeptonSFHelper::SetElectronElectronHistos( ){
  std::string TRIGGERinputFile = "data/leptonSF/triggerSummary_ee.root";
...
void LeptonSFHelper::SetMuonMuonHistos( ){
  std::string TRIGGERinputFile = "data/leptonSF/triggerSummary_mumu.root";
...
void LeptonSFHelper::SetElectronMuonHistos( ){
  std::string TRIGGERinputFile = "data/leptonSF/triggerSummary_emu.root";
